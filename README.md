...
I’m **Anjana Jose**, a final-year MSc student in **Econometrics and Financial Technology** at **Cochin University of Science and Technology (Centre for Budget Studies)**.  
...
- **PG Capstone Project – Credit Risk Prediction**  
  *“Assessing Credit Risk: Predicting Non–Performing Assets Using Regression Analysis”*  
  - Built a **logistic regression model** to predict loan defaults using a dataset with **2.5+ lakh entries** (SPSS)  
